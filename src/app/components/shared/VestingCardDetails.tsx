...
import {  VestingContract } from "@/lib/web3";
...
//  const VestingRounds = [
//    { id: 0, name: "Team", Label: "Team" },
//    { id: 1, name: "Advisor_Partners", Label: "Advisor/Partners" },
//    { id: 2, name: "Liquidity", Label: "Liquidity" },
//    { id: 3, name: "Dao_Ecosystem", Label: "Dao Ecosystem" },
//    { id: 4, name: "Reserve_Insurance", Label: "Reserve Insurance" },
//    { id: 5, name: "Operations_Marketing", Label: "Operations/Marketing" },
//    { id: 6, name: "Burn", Label: "Burn" },
//    { id: 7, name: "Security_BugBounty", Label: "Security/BugBounty" },
//    { id: 8, name: "Awards_Airdrop_Lottery", Label: "Awards/Airdrop/Lottery" },
//  ];
  const rounds = [
    "Team",
    "Advisor_Partners",
...
// }
const VestingCardDetails:React.FC = () => {
    ...
    //  const searchParams = useSearchParams();
     ...
     const claim = async (address: string, roundIndex: number) => {
       try {
         const finalResult = await VestingContract.methods
     ...
     const calculateClaimable = async (
       ...
       try {
         const claimable = await VestingContract.methods
           .calculateClaimable(
     ...
     const calculateInitialClaimable = async (
       ...
       try {
         const initialClaimable = await VestingContract.methods
           .calculateInitialClaimable(
             beneficiaryAddress.toString(),
             selectedRound
           )
           .call({ from: address });
       ...
       const fetchVestingData = async () => {
         try {
           if (isConnected && address) {
             const vestingData: TokenSchedule[] = await VestingContract.methods
...
export default VestingCardDetails;
